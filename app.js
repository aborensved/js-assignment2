...
function taskFive() {
  ...
  document.getElementById('answer-five').innerHTML = `<span><b>Ätligt:</b> ${eatable} </span> <span><b>Skräp:</b> ${trash} </span>`;
...
document.getElementById('answer-six').innerHTML = `<span><b>Över 30:</b> ${overThirty}</span>
...
function taskSeven() {
  ...
  document.querySelector('#answer-seven').innerHTML = formatted;
}
...
function taskEight() {
  ...
  document.querySelector('#card-eight').style.visibility = 'hidden';

  setTimeout(() => {
    document.querySelector('#card-eight').style.visibility = 'visible'
  }, 3000);
